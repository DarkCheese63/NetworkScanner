...
scan_modes = { "stealth": "-sS", "aggressive": "-A", "fast": "-F", "os": "-O", "ping": "-sn", "version": "-sV", "default": "" }
...
def main():
    ...
    while True:
        ...
        scan_option = input ("Enter the choosen scan: ")
